...
for i in 1:iterations
    total_travel_cost_h1, improved_travel_cost_h1, optimal_value, h1_ls_time, gurobi_time_h1 = heuristic_1.nearest_neighbor_heuristic(cities, distances, minimum_profit, n)
    total_travel_cost_h2, improved_travel_cost_h2, h2_ls_time = heuristic_2.cheapest_insertion_heuristic(cities, distances, minimum_profit, n)
