...
for i in 1:iterations
    ...
    recollected_prize_h1, total_travel_cost_h1, improved_travel_cost_h1, optimal_value_h1, optimality_gap_h1 = heuristic_1.nearest_neighbor_heuristic(filename, distances)
    recollected_prize_h2, total_travel_cost_h2, improved_travel_cost_h2, optimal_value_h2, optimality_gap_h2 = heuristic_2.cheapest_insertion_heuristic(filename, distances)
