...
function experiments_table(iteration, total_travel_cost_h1::Int, recollected_prize_h1::Int, improved_travel_cost_h1::Int, optimal_value_h1::Float64, optimality_gap_h1::Float64, total_travel_cost_h2::Int, recollected_prize_h2::Int, improved_travel_cost_h2::Int, optimal_value_h2::Float64, optimality_gap_h2::Float64)
