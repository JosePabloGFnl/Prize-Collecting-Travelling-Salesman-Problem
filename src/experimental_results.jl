...
function experiments_table(iteration, total_travel_cost_h1::Int, improved_travel_cost_h1::Int, optimal_value::Float64, h1_ls_time, gurobi_time_h1, total_travel_cost_h2::Int, improved_travel_cost_h2::Int, h2_ls_time)
    push!(results, (
        iteration,
